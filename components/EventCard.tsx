...
const EventCard: React.FC<EventCardProps> = ({ event, index }) => {
  ...
  return (
    ...
    >
      {/* Background de Partículas Apenas para o Baile de Gala */}
      {isGala && (
      ...
      {/* Decorative Side Bar - Ajustado z-index */}
      <div className={`absolute top-0 left-0 w-1 h-full z-20 ${isGala ? 'bg-gold-300' : 'bg-gold-500'}`}></div>

      {/* Conteúdo encapsulado em z-10 para ficar acima das partículas */}
